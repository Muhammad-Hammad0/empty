    ...
    if (element) {
        $.ajax({
            ...
            success: function(data) {
                ...
                var sheet, darkSheet, sheetName, darkSheetName = 'dark',
                    sheetAdded = false,
                ...
                jQuery('.list-color li').each(function() {
                    ...
                    link.on('click', function(e) {
                        ...
                        if (!sheetAdded) {
                            sheet = jQuery('<link>').attr('rel', 'stylesheet').attr('type', 'text/css').attr('href', 'css/color/' + sheetName + '.css').appendTo('head');
                            sheetAdded = true;
                        } else {
...
(function($) {
            ...
            this.clickHandler = function(e) {
                ...
                if (attr != '#') {
                    ...
                    self.ajaxLoad(attr).done(function(data) {
                        var content = jQuery(data).filter('.blogs-block').css({
                            opacity: 0
                        });
    ...
    $.fn.ajaxPopup = function(options) {
        return this.each(function() {
            $(this).data('AjaxPopup', new AjaxPopup($.extend(options, {
                holder: this
            })));
        });
    };
    ...
    $.extend(ComboBox.prototype, {
        ...
        refreshSelectedText: function() {
            var selectedIndex = this.realElement.prop('selectedIndex'),
                ...
                selectedOptionClasses, selectedFakeElement;
...
(function($) {
    ...
    GoogleMapAPI.prototype = {
        ...
        findStructure: function() {
            this.container = $(this.options.container);
            this.lat = parseFloat('43.2449767');
            this.lng = parseFloat('6.0699624');
